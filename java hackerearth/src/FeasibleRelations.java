      ...
      */
        ...
        while (t-->0)
        {
            ...
            for(int i=1;i<=noOfVariables;i++)
                ds.makeSet(i);
            int vertex1[]=new int[noOfRelations];
            String relations[]=new String[noOfRelations];
            int vertex2[]=new int[noOfRelations];
            for(int i=0;i<noOfRelations;i++)
            {
                vertex1[i]=sc.nextInt();
                relations[i]=sc.next();
                vertex2[i]=sc.nextInt();
            }
//            debug(relations);
            for(int i=0;i<noOfRelations;i++)
            {
            ...
            for(int i=0;i<noOfRelations;i++)
            {
                ...
                {
                    if(ds.findSet(vertex1[i])==ds.findSet(vertex2[i]))
                    {
                        isPossible=false;
                        break;
                    }
