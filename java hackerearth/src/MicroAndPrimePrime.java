...
public class MicroAndPrimePrime {
    ...
    public static void main(String[] args) {
      ...
      */
        ...
        long noOfPrimePrimes[]=new long[MAX+1];

        for(int i=1;i<=MAX;i++)
        {
            if(isPrime[noOfPrimes[i]])
            {
                noOfPrimePrimes[i]=noOfPrimePrimes[i-1]+1;
            }
            else
                noOfPrimePrimes[i]=noOfPrimePrimes[i-1];
        }
        ...
        while (noOfTests-->0)
        {
            int l=sc.nextInt();
            int r=sc.nextInt();
            out.println(noOfPrimePrimes[r]-noOfPrimePrimes[l-1]);
        }
