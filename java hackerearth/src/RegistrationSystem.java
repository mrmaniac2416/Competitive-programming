/**
 * Created by Chirag on 06-06-2017.
    ...
    static  class TrieImplementation{
        ...
        void insert(String s)
        {
            ...
            if(temp.isEndOfWord)
            {
                ...
                {
                    temp.characters.put('0',new TrieNode());
                    added='0';
                }
                else

                {
                    if(temp.characters.get(temp.characters.keySet().iterator().next()).isEndOfWord) {
                        int index=0;
                        while (temp.characters.containsKey(Character.forDigit(index,10)) && temp.characters.get(Character.forDigit(index,10)).isEndOfWord)
                        {
                            index++;
                        }
                        temp.characters.put(Character.forDigit(index, 10), new TrieNode());
                        added = Character.forDigit(index, 10);
                    }
                    else
                    {
                        temp.characters.put('0',new TrieNode());
                ...
                temp=temp.characters.get(added);
            }
            else
                added=' ';
            temp.isEndOfWord=true;
            System.out.println(s+Character.toString(added));
        }
        void bfs()
        {
            TrieNode temp=root;
