...
public class justshortestdistance {
    ...
    public static int bfs(HashMap<Integer,HashSet<Integer>> graph,int n,int x)
    {
        if(x==1)
            return 0;
