...
public class monksbirthdaytreat {
    public static void main(String[] args) {
      ...
      */
        ...
        int minNoOfPeople=Integer.MAX_VALUE;
        for(int i=1;i<=n;i++)
        {
            int min=0;
            if(minNoOfPeople>(min=dfs(graph,i)))
                minNoOfPeople=min;
        }
//        debug(graph);
        out.print(minNoOfPeople);
...
public static int dfs(HashMap<Integer,HashSet<Integer>> graph,int start)
{
