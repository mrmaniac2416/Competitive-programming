...
public class ScarborughFair {
    public static void main(String[] args) {
      ...
      */
        ...
        for(int i=0;i<noOfOperations;i++)
        {
            int l=sc.nextInt();
            int r=sc.nextInt();
            char givenCharacter=sc.nextCharacter();
            char toReplace=sc.nextCharacter();
            for(int j=l;j<=r;j++)
            {
                if(str.charAt(j)==givenCharacter)
                    str.setCharAt(j,toReplace);
            }
        }
        str.deleteCharAt(0);
    ...
    public static class MyScanner {
        ...
        char nextCharacter() {return next().charAt(0);}
